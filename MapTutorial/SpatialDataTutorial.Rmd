...
setwd("~/Desktop/ComputationalBiology_SPRING2017/Bio381/MapTutorial/") # setting working directory
...
plot(lnd[ sel, ], col = "turquoise", add = TRUE) # add selected zones to map - add=TRUE creates this as a layer on top of the map
