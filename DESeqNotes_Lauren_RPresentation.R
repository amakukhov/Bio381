### DESeq2 Notes - Lauren's presentation ###
### Wed, May 3rd, 2017
### ADG
...
plotCounts(dds, gene="ENSG00000152583", intgroup="dex") #intgroup determines how it's going to parse out the counts
...
plotPCA(vsdata, intgroup="dex") #using the DESEQ2 plotPCA fxn we can, intgroup = group of interest (dex = diffentially expressed)
