...
oopt = ani.options(interval = 0.3, nmax = ifelse(interactive(), #if else(interactive() meaning assumed human operator that can dictate some of these parameters
                                                 50, 2))
...
par(ann = FALSE, mar = rep(0, 4)) # ann = FALSE means no annotations
