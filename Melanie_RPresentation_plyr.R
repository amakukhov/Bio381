...
## ddply - the first d stands for input = dataframe, the second d stands for the output = dataframe
# d_ply inputs a dataframe but doesn't output anything, useful for plots
...
monthlyData <- ddply(climate, # input data frame 
                     ...
                     MeanAirTemp = mean(AvgAirTemp)) # function to apply to each subset # has to have equal sign here, not arrow
print(monthlyData)
